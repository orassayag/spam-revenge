...
const localUtils = require('./files/local.utils');
...
module.exports = {
    applicationUtils, colorUtils, crawlUtils, fileUtils, localUtils, logUtils,
    pathUtils, regexUtils, systemUtils, textUtils, timeUtils, validationUtils
};